...
class Scene5_1(Scene):
    ...
    def construct(self):
        ...
        # =====================================================================
        # LỜI THOẠI: "Tổng kết lại, hành trình của chúng ta đi qua ba phần:
        # bộ sinh token cơ bản; các meta-generators điều phối tìm kiếm và tự sửa lỗi;
        # và các kỹ thuật tối ưu hóa phần cứng hệ thống khi vận hành."
        # =====================================================================
        ...
        # =====================================================================
        # LỜI THOẠI: "Phiên thảo luận Panel của chúng ta quy tụ các chuyên gia hàng đầu
        # từ OpenAI, DeepMind, Oxford, CMU và AI2, dưới sự điều phối của Ilia Kulikov từ Meta AI."
        # =====================================================================
        # Panel participants.
        ...
        # =====================================================================
        # LỜI THOẠI: "Câu hỏi lớn được đặt ra là: liệu các mô hình pretrained lớn hơn trong tương lai
        # có làm biến mất nhu cầu về các giải thuật tìm kiếm lúc suy luận?"
        # =====================================================================
        ...
        # =====================================================================
        # LỜI THOẠI: "Panel nhận định hai hướng này bổ trợ cho nhau. Dù mô hình lớn hơn,
        # Nouha Dziri nhấn mạnh chúng vẫn gặp hai giới hạn: tích tụ sai số và khó nhìn xa
        # nhiều bước lập luận. Do đó, các giải thuật tìm kiếm cây, quay lui và chấm điểm
        # từng bước PRM vẫn là lớp cấu trúc bổ sung không thể thiếu để nâng cao độ chính xác."
        # =====================================================================
        ...
        # =====================================================================
        # LỜI THOẠI: "Về giới hạn mở rộng suy luận, điểm nghẽn chính nằm ở chất lượng bộ kiểm chứng verifier.
        # Dù vậy, Noam Brown khẳng định: tính toán lúc suy luận là một ranh giới vô hạn.
        # Với bài toán cực kỳ quan trọng như toán học hay y sinh, chúng ta sẵn sàng chi trả chi phí lớn
        # để có câu trả lời chính xác thông qua tìm kiếm cây. Hướng đi tương lai là LLM tự học cách tìm kiếm và sửa lỗi."
        # =====================================================================
        noam = self.quote_box(
            "Noam Brown (OpenAI)",
        ...
        # =====================================================================
        # LỜI THOẠI: "Về hiệu năng, Beidi Chen nhấn mạnh phần cứng trước đây tối ưu cho training,
        # nhưng nay inference sẽ chiếm chủ đạo. Do đó, đồng thiết kế thuật toán tìm kiếm và phần cứng GPU
        # là cơ hội lớn để giảm chi phí, mở đường cho hệ thống lai dùng công cụ ngoài và các bộ kiểm chứng
        # dạng ngôn ngữ hoạt động hiệu quả."
        # =====================================================================
        ...
        # =====================================================================
        # LỜI THOẠI: "Tổng kết lại, tương lai AI không chỉ nằm ở mô hình lớn hơn, mà là các hệ thống
        # biết suy nghĩ và phân bổ compute suy luận tối ưu. Cảm ơn các bạn đã đồng hành cùng chúng ta
        # từ giải mã cơ bản đến meta-generation nâng cao. Toàn bộ slide và mã nguồn được đính kèm dưới phần mô tả."
        # =====================================================================
