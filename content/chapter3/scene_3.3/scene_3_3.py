...
class Scene3_3(Scene):
    def construct(self):
        ...
        voiceover_end = 0.0
        voiceover_end = add_voiceover(self, "sc33_1.mp3", voiceover_end, 19.273)
        voiceover_end = add_voiceover(self, "sc33_2.mp3", voiceover_end, 11.981)
        voiceover_end = add_voiceover(self, "sc33_3.mp3", voiceover_end, 18.576)
        voiceover_end = add_voiceover(self, "sc33_4.mp3", voiceover_end, 19.644)
        voiceover_end = add_voiceover(self, "sc33_5.mp3", voiceover_end, 23.452)
        voiceover_end = add_voiceover(self, "sc33_6.mp3", voiceover_end, 14.164)
        ...
        chapter_sub = create_text("Part 3.3: Tree Search & Backtracking", font_size=18, color=GRAY_A)
        ...
        # Note: visual/narration alignment comment translated from Vietnamese.
        sub_title = create_text("Tree search & Quay lui (Tree Search & Backtracking)", font_size=15, color=YELLOW)
        ...
        intro_text = create_text(
            "If the language model makes a mistake at the first reasoning step,\n"
            "continuing to generate later tokens wastes compute resources.",
        ...
        lbl1_1 = create_text("Step 1: Wrong", font_size=10, color=RED).move_to(box1_1.get_center())
        ...
        lbl1_2 = create_text("Step 2", font_size=10, color=GRAY_B).move_to(box1_2.get_center())
        ...
        lbl1_3 = create_text("Step 3", font_size=10, color=GRAY_B).move_to(box1_3.get_center())
        ...
        lbl2_1 = create_text("Step 1: Correct", font_size=10, color=GREEN).move_to(box2_1.get_center())
        ...
        lbl2_2 = create_text("Step 2", font_size=10, color=WHITE).move_to(box2_2.get_center())
        ...
        lbl2_3 = create_text("Step 3", font_size=10, color=WHITE).move_to(box2_3.get_center())
        ...
        wasted_lbl = create_text("Wasted Compute", font_size=9, color=RED)
        ...
        design_title = create_text("4 basic Tree Search design elements:", font_size=14, color=YELLOW).move_to(UP * 2.0)
        ...
        intro_part2 = create_text(
            "PRM scores each intermediate reasoning step to control progress,\n"
            "unlike ORM, which only scores the final result.",
            font_size=13, color=WHITE, line_spacing=1.3
        ).move_to(UP * 2.1)
        ...
        # Note: visual/narration alignment comment translated from Vietnamese.
        # =====================================================================
        part3_title = create_text("3. Search & Backtracking Animation", font_size=13, color=BLUE_A)
        ...
        # Note: visual/narration alignment comment translated from Vietnamese.
        # =====================================================================
        part4_title = create_text("4. Rebase Algorithm (Reward Balanced Search)", font_size=13, color=BLUE_A)
        ...
        # Note: visual/narration alignment comment translated from Vietnamese.
        sim_title = create_text("Example: Budget = 10 streams | Temperature τ = 0.3", font_size=12, color=YELLOW).move_to(UP * 0.5)
        ...
        # Note: visual/narration alignment comment translated from Vietnamese.
        # =====================================================================
        part5_title = create_text("5. Tree Traversal Algorithms & Real Applications", font_size=13, color=BLUE_A)
