...
class Scene3_1(Scene):
    def construct(self):
        ...
        voiceover_end = 0.0
        voiceover_end = add_voiceover(self, "sc31_1.mp3", voiceover_end, 13.688)
        voiceover_end = add_voiceover(self, "sc31_2.mp3", voiceover_end, 28.735)
        voiceover_end = add_voiceover(self, "sc31_3.mp3", voiceover_end, 17.972)
        voiceover_end = add_voiceover(self, "sc31_4.mp3", voiceover_end, 22.596)
        voiceover_end = add_voiceover(self, "sc31_5.mp3", voiceover_end, 41.979)
        voiceover_end = add_voiceover(self, "sc31_6.mp3", voiceover_end, 23.249)
        voiceover_end = add_voiceover(self, "sc31_7.mp3", voiceover_end, 23.406)
        ...
        # Note: visual/narration alignment comment translated from Vietnamese.
        # =====================================================================
        part1_title = create_text("1. High-Level Orchestrators (Meta-Generation Strategies)", font_size=13, color=BLUE_A)
        ...
        intro_text = create_text(
            "Treat all primitive autoregressive generation algorithms from Chapter 2\n"
            "as a black box and build an external orchestrator around them.",
        ...
        feedback_lbl = create_text("Macro feedback (Feedback Loop)", font_size=9, color=BLUE_A)
        ...
        formal_title = create_text("Mathematical definition", font_size=11, color=YELLOW).next_to(formal_box.get_top(), DOWN, buff=0.18)
        ...
        # Note: visual/narration alignment comment translated from Vietnamese.
        # =====================================================================
        part2_title = create_text("2. Outcome-based reward model (Outcome-based Reward Model)", font_size=13, color=BLUE_A)
        ...
        rm_intro = create_text(
            "Outcome-based Reward Model (Evaluator / Verifier) is trained\n"
            "as a classifier to score complete answers.",
            font_size=13, color=WHITE, line_spacing=1.3
        ).move_to(UP * 1.5)
        ...
        sample_correct = VGroup(
            ...
            create_text("Answer A\n(Correct)", font_size=10, color=WHITE),
        ...
        sample_incorrect = VGroup(
            ...
            create_text("Answer B\n(Error)", font_size=10, color=WHITE),
        ...
        outcome_lbl = create_markup_text(
            "<b>Core property (Outcome-based):</b> It scores only once at the end\n"
            "of the full text sequence. It does not supervise intermediate reasoning step by step.",
        ...
        # Note: visual/narration alignment comment translated from Vietnamese.
        # =====================================================================
        part3_title = create_text("3. Chaining techniques & Chain of Thought (Chain of Thought)", font_size=13, color=BLUE_A)
        ...
        chain_intro = create_markup_text(
            "Decompose a complex reasoning problem into sequential solution steps:\n"
            "Prompt <i>x</i> → intermediate thoughts <i>z</i> → final answer <i>y</i>",
            font_size=13, color=WHITE, line_spacing=1.3
        ).move_to(UP * 1.5)
        ...
        # Note: visual/narration alignment comment translated from Vietnamese.
        compare_lbl_1 = create_text("Method 1: Direct solving (Direct)", font_size=11, color=GRAY_A)
        ...
        direct_flow = VGroup(
            ...
            create_text("Answer y", font_size=10, color=RED),
        ...
        compare_lbl_2 = create_text("Method 2: Reasoning chain (Chaining/CoT)", font_size=11, color=GRAY_A)
        ...
        chain_flow = VGroup(
            ...
            Arrow(start=LEFT*0.3, end=RIGHT*0.3, color=GRAY_D, stroke_width=1.5),
            create_text("Answer y", font_size=10, color=GREEN),
        ...
        chain_formulas = create_markup_text(
            "Formula:  y<sub>1</sub> ~ g<sub>1</sub>(x),   y<sub>2</sub> ~ g<sub>2</sub>(x, y<sub>1</sub>),   y<sub>3</sub> ~ g<sub>3</sub>(x, y<sub>2</sub>)",
        ...
        # Note: visual/narration alignment comment translated from Vietnamese.
        scratchpad_lbl = create_text("Intermediate tape (Scratchpad Memory Tape)", font_size=12, color=YELLOW)
        ...
        express_lbl = create_markup_text(
            "<b>Expressiveness (Turing Machine Expressiveness):</b> Generating intermediate tokens\n"
            "such as <i>z<sub>1</sub>, z<sub>2</sub>, z<sub>3</sub></i> act as auxiliary memory and provide compute resources\n"
            "that help the model go beyond the fixed-depth limits of Transformer architecture.",
        ...
        # Note: visual/narration alignment comment translated from Vietnamese.
        # =====================================================================
        part4_title = create_text("4. Self-Ask workflow (Self-Ask) & Tool Use (Tool Use)", font_size=13, color=BLUE_A)
        ...
        final_ans_text = create_markup_text(
            "<b>Answer y:</b> <i>\"Final Answer (Aggregated from sub-answers)\"</i>",
        ...
        c3 = make_grid_cell("3. Tree Search (Tree search)", "Traverse trees ToT, MCTS, Backtracking.\nUse PRM to score each reasoning step.", LEFT * 2.8 + DOWN * 1.5, get_tree_icon, color=ORANGE)
        c4 = make_grid_cell("4. Self-Correction (Self-correction)", "The model revises its own draft.\nReceive extrinsic / intrinsic feedback.", RIGHT * 2.8 + DOWN * 1.5, get_correction_icon, color=PURPLE_A)
