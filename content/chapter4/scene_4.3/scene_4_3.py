...
class Scene4_3(Scene):
    def construct(self):
        ...
        voiceover_end = 0.0
        voiceover_end = add_voiceover(self, "sc43_1.mp3", voiceover_end, 10.263)
        voiceover_end = add_voiceover(self, "sc43_2.mp3", voiceover_end, 13.282)
        voiceover_end = add_voiceover(self, "sc43_3.mp3", voiceover_end, 21.455)
        voiceover_end = add_voiceover(self, "sc43_4.mp3", voiceover_end, 30.186)
        voiceover_end = add_voiceover(self, "sc43_5.mp3", voiceover_end, 12.585)
        voiceover_end = add_voiceover(self, "sc43_6.mp3", voiceover_end, 22.291)
        voiceover_end = add_voiceover(self, "sc43_7.mp3", voiceover_end, 23.963)
        voiceover_end = add_voiceover(self, "sc43_8.mp3", voiceover_end, 21.780)
        voiceover_end = add_voiceover(self, "sc43_9.mp3", voiceover_end, 15.882)
        voiceover_end = add_voiceover(self, "sc43_10.mp3", voiceover_end, 30.465)
        voiceover_end = add_voiceover(self, "sc43_11.mp3", voiceover_end, 25.728)
        voiceover_end = add_voiceover(self, "sc43_12.mp3", voiceover_end, 22.988)
